...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-800 dark:text-white tracking-tight">Edit Guru</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Perbarui informasi guru.</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-slate-800 p-8 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-sm">
        <form action="{{ route('admin.teachers.update', $teacher) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <x-text-input id="nip" name="nip" type="text" class="mt-1 block w-full" :value="old('nip', $teacher->nip)" autocomplete="nip" />
            ...
            <div>
                ...
                <x-text-input id="subject" name="subject" type="text" class="mt-1 block w-full" :value="old('subject', $teacher->subject)" required autocomplete="subject" />
