...
<div class="max-w-12xl mx-auto">
    <div class="mb-8 flex items-center justify-between">
        <div class="flex items-center gap-4">
            <a href="{{ route('admin.students.index') }}" class="p-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-400 hover:text-blue-600 transition-all shadow-sm">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
            </a>
            <h1 class="text-2xl font-bold text-slate-800 dark:text-white">Impor Data Siswa</h1>
        </div>
    </div>
        ...
        <div class="md:col-span-1 space-y-6">
            <div class="bg-blue-600 rounded-3xl p-6 text-white shadow-xl shadow-blue-200 dark:shadow-none">
                ...
                <ul class="text-xs space-y-3 opacity-90 font-medium">
                    ...
                    <li>2. Isi data sesuai kolom (NIS, NISN, RFID Number, Nama, Classroom ID).</li>
                    <li>3. Classroom ID adalah ID kelas yang dapat dilihat di menu Kelola User.</li>
                    <li>4. Pastikan NIS dan NISN tidak duplikat.</li>
                    <li>5. RFID Number bersifat opsional.</li>
                </ul>
                <a href="{{ route('admin.students.export') }}" class="mt-6 inline-flex items-center justify-center w-full py-3 bg-white text-blue-600 rounded-xl font-bold text-sm hover:bg-blue-50 transition-colors">
                    📥 Unduh Template
                </a>
            </div>
        </div>
